...
def main():
    ...
    train_file = glob.glob('/home/gt/tasks_1-20_v1-2/en-10k/qa%d_*train.txt' % args.task)[0]
    test_file = glob.glob('/home/gt/tasks_1-20_v1-2/en-10k/qa%d_*test.txt' % args.task)[0]
